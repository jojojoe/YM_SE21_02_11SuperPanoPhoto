...
@property (nonatomic, assign) CGFloat VO_realRatio;
@property (nonatomic, assign) BOOL VO_isSpiltAreaFilter;
@property (nonatomic, weak) GPUImageFilter *VO_inputFilter;
