...
@property (nonatomic, weak) GPUImageMovie *VO_currentAddonMovie;
@property (nonatomic, weak) GPUImageMovie *VO_originalMovie;
@property (nonatomic, assign) CMTime VO_frameRate; // use for original video
@property (nonatomic, assign) float VO_currentFrameIndex; // use for addon
@property (nonatomic, assign) CMSampleBufferRef VO_previousSampleBuffer;
@property (nonatomic, assign) BOOL VO_pauseReading;
@property (nonatomic, assign) NSInteger VO_counter;
@property (nonatomic, strong) AVMutableAudioMix *VO_audioMix;
